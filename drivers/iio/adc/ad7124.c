...
static int ad7124_disable_channel(struct ad_sigma_delta *sd, unsigned int channel)
{
	struct ad7124_state *st = container_of(sd, struct ad7124_state, sd);
	struct ad7124_channel *ch = &st->channels[channel];

	return ad_sd_write_reg(&st->sd, AD7124_CHANNEL(ch->nr), 2, 0);
}
...
static const struct ad_sigma_delta_info ad7124_sigma_delta_info = {
	...
	.disable_channel = ad7124_disable_channel,
